...
for (let [numCircles, x, z, firstRadius] of gulfLocations)
	createArea(
		new ChainPlacer(
			2,
...
createStragglerTrees([oPine], avoidClasses(clWater, 3, clForest, 1, clHill, 1, clPlayer, 12, clMetal, 6, clRock, 6));
