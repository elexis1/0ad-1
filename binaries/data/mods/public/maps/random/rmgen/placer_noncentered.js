...
PathPlacer.prototype.place = function(constraint)
{
	...
	if (failed > this.width * this.failfraction * dist2) // TODO which dist?
		return undefined;
...
/**
 * Class testing wheather all points between (x1, z1) and (x2, z2) are
 * within the map boundaries and meet the given constraint.
 */
