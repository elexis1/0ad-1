...
var islandX = [fractionToTiles(0.01), fractionToTiles(0.99)];
...
for (let island = 0; island < 2; ++island)
{
	...
	createArea(
		new ClumpPlacer(fractionToSize(0.3) * 1.8, 1, 0.5, 10, Math.round(islandX[island]), Math.round(islandZ[island])),
		[
